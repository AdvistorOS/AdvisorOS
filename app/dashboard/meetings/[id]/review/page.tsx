...
import { ArrowLeft, CheckCircle2, XCircle, Edit3, Check, AlertTriangle, Eye, EyeOff } from "lucide-react";

type Field = { key: string; category: string; label: string; value: string; evidence: string; confidence: "high" | "medium" | "low" };
