...
export default function FollowupEmailPage() {
  ...
  useEffect(() => {
    fetch("/api/generate-followup-email", { method: "POST", body: JSON.stringify({ meetingId: id }) })
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="font-display text-2xl text-ink mb-1">Follow-up email</h1>
        <p className="text-ink-muted text-sm mb-6">Draft — review before sending.</p>
        {loading ? (
